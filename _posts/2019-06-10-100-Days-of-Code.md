...
| **2019.06.16** _(Tue, Day 7) | It's been a long day & there's little actual coding I'm doing (outside above mention), but I'm getting comfortable with VIM! Opted today to use VsCodeVim to generate some Splunk/Netscaler commands for work, which worked out pretty well (even considering time restraints & the semi-awkward middle ground that is VsCodeVim). Tomorrow, I'll look into scripting my environment to import plugins/extensions. | 